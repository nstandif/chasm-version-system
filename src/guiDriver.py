...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.localFilesTreeWidget = QtGui.QTreeWidget(self.localFilesTab)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.localFilesTreeWidget.headerItem().setText(0, QtGui.QApplication.translate("MainWindow", "File Name", None, QtGui.QApplication.UnicodeUTF8))
        self.localFilesTreeWidget.headerItem().setText(1, QtGui.QApplication.translate("MainWindow", "Check Out Time", None, QtGui.QApplication.UnicodeUTF8))
        self.localFilesTreeWidget.headerItem().setText(2, QtGui.QApplication.translate("MainWindow", "Last Opened", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.toolbar.setWindowTitle(QtGui.QApplication.translate("MainWindow", "Tool Bar", None, QtGui.QApplication.UnicodeUTF8))
    ...
    def connectSignalsAndSlots(self, MainWindow):
        ...
        QObject.connect(self.localFilesTreeWidget, SIGNAL("currentItemChanged(QTreeWidgetItem, QTreeWidgetItem)"), controller.localItemSelectionChanged)
        QObject.connect(self.localFilesTreeWidget, SIGNAL("customContextMenuRequested(QPoint)"), controller.localFilesContextMenu)
        QObject.connect(self.projectFilesTreeWidget, SIGNAL("currentItemChanged(QTreeWidgetItem, QTreeWidgetItem)"), controller.projectItemSelectionChanged)
